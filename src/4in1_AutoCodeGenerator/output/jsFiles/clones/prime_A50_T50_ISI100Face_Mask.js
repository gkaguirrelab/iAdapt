(function() {
	...
	var faceArray = loadCSVfile(params.prime_A50_T50_ISI100Face_Mask.stimulusList);
	// Load the trial sequence from external file
	var temp = loadCSVfile(params.prime_A50_T50_ISI100Face_Mask.stimulusSeq);
	...
	var temp = loadCSVfile(params.prime_A50_T50_ISI100Face_Mask.primeSeq);
	var seqLen = temp.length;
	var primeSeq = [];
	...
	var temp = loadCSVfile(params.prime_A50_T50_ISI100Face_Mask.wheelRotation);
	...
	var preExperInstruction = loadTXTfile(params.prime_A50_T50_ISI100Face_Mask.instructionsPre);
	var breakInstruction = loadTXTfile(params.prime_A50_T50_ISI100Face_Mask.instructionsBreak);
	var postExperInstruction = loadTXTfile(params.prime_A50_T50_ISI100Face_Mask.instructionsPost);

	var trialsPerBlock = params.prime_A50_T50_ISI100Face_Mask.trialsPerBlock;
	var totalTrials = params.prime_A50_T50_ISI100Face_Mask.totalTrials;
	var screenHeight = screen.height;
	var windowHeight = $(window).height();
	var windowWidth = $(window).width();
	var divHeight = $("#content").height();
	var circleSize = divHeight * params.prime_A50_T50_ISI100Face_Mask.wheelSize;
	var centerSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.centerSize;
	var calibratorSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.centerSize;
	var thumbSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.thumbSize;

	var textColor = params.prime_A50_T50_ISI100Face_Mask.textColor;
	var instructWidth = params.prime_A50_T50_ISI100Face_Mask.instructWidth;
	var instructHeight = params.prime_A50_T50_ISI100Face_Mask.instructHeight;
	var fontSize = params.prime_A50_T50_ISI100Face_Mask.instructFontsize;
	var buttonWidth = params.prime_A50_T50_ISI100Face_Mask.instructButtonwidth;
	var buttonHeight = params.prime_A50_T50_ISI100Face_Mask.instructButtonHeight;
	var buttonFontSize = params.prime_A50_T50_ISI100Face_Mask.instructButtonfontSize;
	var instructShiftFromTop = params.prime_A50_T50_ISI100Face_Mask.instructShiftFromTop;

	var minimumClickTime = params.prime_A50_T50_ISI100Face_Mask.minimumClickTime;
	var maxClickTime = params.prime_A50_T50_ISI100Face_Mask.maxClickTime;
	var primeDetect = params.prime_A50_T50_ISI100Face_Mask.primeDetect;
	...
	var trial = 0;
	var dbTableName = params.prime_A50_T50_ISI100Face_Mask.dbTableName;
	...
	function initializeExperiment() {
		...
		$("#content").css({"background-color": "rgb" +params.prime_A50_T50_ISI100Face_Mask.backgroundcolor});
		$("#header").css({"background-color": "rgb" +params.prime_A50_T50_ISI100Face_Mask.backgroundcolor});
		// Reset header text
		$("#header").html("");
		$("#header").hide();
		...
		//Set mask source
		$(".mask").attr('src',params.prime_A50_T50_ISI100Face_Mask.maskAddress);
		$(".mask").hide();
		// target
	...
	function setStyle(){
		...
		if($(window).width() != windowWidth || $(window).height() != windowHeight){
			...
			circleSize = divHeight * params.prime_A50_T50_ISI100Face_Mask.wheelSize;
			centerSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.centerSize;
			calibratorSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.centerSize;
			thumbSize = circleSize * params.prime_A50_T50_ISI100Face_Mask.thumbSize;
		}
		// Define the style of the face circle
		$("#progress-container").css({
		    'width': ''+(windowWidth*params.prime_A50_T50_ISI100Face_Mask.progressWidth)+'px',
		    'position': 'fixed',
		    'left':''+((windowWidth/2) - (windowWidth*params.prime_A50_T50_ISI100Face_Mask.progressWidth)/2)+'px',
		    'top':params.prime_A50_T50_ISI100Face_Mask.progressPercentFromTop +'%',
		    'height': windowHeight*params.prime_A50_T50_ISI100Face_Mask.progressHeight+'px',
		    'background-color':'rgb'+params.prime_A50_T50_ISI100Face_Mask.progressBackgroundColor
		});
		$("#progress-bar").css({
		  	'background-color':'rgb'+params.prime_A50_T50_ISI100Face_Mask.progressForegroundColor,
		  	'width': '0%',
		  	'height': windowHeight*params.prime_A50_T50_ISI100Face_Mask.progressHeight+'px',
		});
...
$("#directions2").css({
	...
	function executeTrial(){
		...
		$(".blank").show();
		setTimeout(function(){$(".blank").hide();time_after_blank0 = $.now(); time_before_prime = $.now();$(".prime").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration);
		setTimeout(function(){$(".prime").hide();time_after_prime = $.now(); time_before_blank1 = $.now();$(".blank").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration);
		setTimeout(function(){$(".blank").hide();time_after_blank1 = $.now(); time_before_mask = $.now();$(".mask").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration + params.prime_A50_T50_ISI100Face_Mask.blank_before_mask);
		setTimeout(function(){$(".mask").hide(); time_after_mask  = $.now(); time_before_blank2 = $.now();$(".blank").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration + params.prime_A50_T50_ISI100Face_Mask.blank_before_mask + params.prime_A50_T50_ISI100Face_Mask.mask_duration);
		setTimeout(function(){$(".blank").hide(); time_after_blank2  = $.now(); time_before_target  = $.now();$(".target").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration+ params.prime_A50_T50_ISI100Face_Mask.blank_before_mask + params.prime_A50_T50_ISI100Face_Mask.mask_duration + params.prime_A50_T50_ISI100Face_Mask.ISI);
		setTimeout(function(){$(".target").hide(); time_after_target = $.now(); time_before_blank3 = $.now(); $(".blank").show();}, params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration+ params.prime_A50_T50_ISI100Face_Mask.blank_before_mask + params.prime_A50_T50_ISI100Face_Mask.mask_duration + params.prime_A50_T50_ISI100Face_Mask.ISI + params.prime_A50_T50_ISI100Face_Mask.target_duration);
		setTimeout(function(){$(".blank").hide(); time_after_blank3 = $.now();$(".face-circle").show();initialTime = $.now();if(maxClickTime != 0){$("#progress-container").show();loadProgressBar('progress-bar', maxClickTime, params.prime_A50_T50_ISI100Face_Mask.progressInterval);setMaxTimer(trial);}

},params.prime_A50_T50_ISI100Face_Mask.blank_before_prime_duration + params.prime_A50_T50_ISI100Face_Mask.prime_duration + params.prime_A50_T50_ISI100Face_Mask.blank_before_mask + params.prime_A50_T50_ISI100Face_Mask.mask_duration + params.prime_A50_T50_ISI100Face_Mask.ISI + params.prime_A50_T50_ISI100Face_Mask.target_duration + params.prime_A50_T50_ISI100Face_Mask.blank_after_target_duration);
	}
	function finalizeTrial(responseDegrees) {
		...
		writeTrialData(expData,trial,dbTableName, params.prime_A50_T50_ISI100Face_Mask.database);
		trial++;
	...
	function takeBreak(){
		...
		if(trial == 0){
			var moneyMadeSoFar = "";
			if(params.prime_A50_T50_ISI100Face_Mask.payByPerformance == 1){
				moneyMadeSoFar = "You have made " +totalEarned/100+"$ so far!\n"
			}
			if(params.prime_A50_T50_ISI100Face_Mask.displayExperNum == 1){setMessage(moneyMadeSoFar + "This is task " + currentExperNum + "/" + protocolList.length + "\n\n"+ preExperInstruction);}else{setMessage(preExperInstruction);}
			...
			var moneyMadeUpdate = "";
			if(params.prime_A50_T50_ISI100Face_Mask.payByPerformance == 1){
				totalEarned += Math.round(parseFloat(Math.max(totalScore, 0) *params.prime_A50_T50_ISI100Face_Mask.paymentFull));
				moneyMadeUpdate = "\nYou earned " +Math.round(parseFloat(Math.max(totalScore, 0) *params.prime_A50_T50_ISI100Face_Mask.paymentFull))+" cents for this task.";
				if(totalScore < params.prime_A50_T50_ISI100Face_Mask.minPerformance){
					poorAccuracy = 1;
				}
			}
	...
	$("#messageButton").click(function() {
		$(".messagedisplay").hide();
		if(trial == 0 && params.prime_A50_T50_ISI100Face_Mask.instructLoop != undefined){
			instructLoop(params.prime_A50_T50_ISI100Face_Mask.instructLoop.questions,
			params.prime_A50_T50_ISI100Face_Mask.instructLoop.choices,
			params.prime_A50_T50_ISI100Face_Mask.instructLoop.answers,initializeTrial);
			loopstatus = 1;
		}else{
			initializeTrial();
		}
...
function prime_A50_T50_ISI100Face_Mask(){
	...
	$("html").click(function(){
		if($(".color-circle").is(":visible")){
			...
			/*
				...
				if(task == "prime_A50_T50_ISI100Face_Mask" || task == "prime_A50_T50_ISI100Face_Mask"){
					//Account for wheel rotation
					if(task == "prime_A50_T50_ISI100Face_Mask"){
						var target = params["primeTargetColorLong"][taskTrialNum - 2] + rotation;
						if (target > 360) target -= 360;
						if (target < 0) target += 360;
						currPrime = calcPrimeOffset(target, params["primeprime_A50_T50_ISI100Face_Mask"][taskTrialNum - 2]);
					}
					else{
						var target = params["primeprime_A50_T50_ISI100Face_Mask"][taskTrialNum - 2] + rotation;
						if (target > 360) target -= 360;
						if (target < 0) target += 360;
						currPrime = calcPrimeOffset(target, params["primeprime_A50_T50_ISI100Face_Mask"][taskTrialNum - 2]);
					}
	...
	if(taskTrialNum <= thisSeq.length){
		if(blockNum == -1){
			...
			setDirections(params.prime_A50_T50_ISI100Face_Mask.instructionsPre);
			$(".directions").show();
			blockNum ++;
		...
		}else if(taskTrialNum <= params.prime_A50_T50_ISI100Face_Mask.trialsPerBlock * blockNum){
			...
			setTimeout(function(){rotateWheel(wheelRotation[taskTrialNum-1][1],"color",params.prime_A50_T50_ISI100Face_Mask.wheelSize);},0);
			...
			setTimeout(function(){$(".colorCenter").hide(); $(".faceCenter").hide();}, 0);
			setTimeout(function(){setDirections(params.prime_A50_T50_ISI100Face_Mask.instructionsBreak);}, 0);
		...
		setTimeout(function(){setDirections(params.prime_A50_T50_ISI100Face_Mask.instructionsPost);}, 0);
		setTimeout(function(){$(".directions").show();}, 0);
		blockNum = -1;
		taskTrialNum = 1;
		//Next task

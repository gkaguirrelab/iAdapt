...
for i = 1:length(stimuli)
    ...
    for j = 1:length(levelsCombine)
        name = [fieldNames{1} num2str(levelsCombine(j, 1)) fieldNames{2} num2str(levelsCombine(j, 2)) fieldNames{3} num2str(levelsCombine(j, 3)) stimulus];
...
for i = 1:length(stimuli)
    ...
    for j = 1:length(oldLevelsCombine)
        name = [fieldNames{1} num2str(oldLevelsCombine(j, 1)) fieldNames{2} num2str(oldLevelsCombine(j, 2)) fieldNames{3} num2str(oldLevelsCombine(j, 3)) stimulus];

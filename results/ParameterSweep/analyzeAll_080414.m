%% PARAMETERS
dbFile = './080414.mat';
dateRange = {'August 1, 2014', 'August 4, 2014'};
targetDur = [50 100 200];
...
for j=1:length(targetDur)
    for k=1:length(ISIDur)
        thisDBnameColor = ['db.data.prime_A5000_T' num2str(targetDur(j)) '_ISI' num2str(ISIDur(k)) 'Color'];
...
figure(2)
labels = {'50/50' '100/50' '200/50' '50/100' '100/100' '200/100' '50/200' '100/200' '200/200' '50/400' '100/400' '200/400'};
subplot(2,1,1)

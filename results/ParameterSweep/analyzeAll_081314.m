%% PARAMETERS
dbFile = './081314.mat';
dateRange = {'August 12, 2014', 'August 13, 2014'};
targetDur = [50, 100];
ISIDur = [400, 800];
adaptorDur = [100, 200, 400];
...
set(gca, 'XTickLabel',{'50/400','100/400','50/800','100/800'}, 'YTick',1:numel({'50/400','100/400','50/800','100/800'}))
ylabel('Adaptor');
xlabel('Target/ISI');
...
figure(2)
labels = {'100/50/400' '200/50/400' '400/50/400' '100/100/400' '200/100/400' '400/100/400' '100/50/800' '200/50/800' '400/50/800' '100/100/800' '200/100/800' '400/100/800'};
subplot(2,1,1)

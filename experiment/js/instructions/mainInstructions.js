(function() {
	...
	//Load instructions
	var instructions = loadTXTfile(instructs.mainInstructions.instructions);
	var screenHeight = screen.height;
	var windowHeight = $(window).height();
	var windowWidth = $(window).width();
	var divHeight = $("#content").height();

	var backgroundcolor = instructs.mainInstructions.backgroundcolor;
	var textcolor = instructs.mainInstructions.textColor;
	var instructWidth = instructs.mainInstructions.width;
	var instructHeight = instructs.mainInstructions.height;
	var fontSize = instructs.mainInstructions.fontsize;
	var buttonWidth = instructs.mainInstructions.buttonwidth;
	var buttonHeight = instructs.mainInstructions.buttonHeight;
	var buttonFontSize = instructs.mainInstructions.buttonfontSize;
	...
	function initialize() {
		...
		$("#content").append("<div class = 'messagedisplay'>\
			...
			<button id ='messageButton'>Click Here To Begin!</button>\
		</div>");
		// $(".messagedisplay").hide();

...
$("#directions2").css({
	...
	function executeTrial(){
		...
		setTimeout(function(){$(".blank").hide();time_after_blank1 = $.now(); time_before_target = $.now();$(".target").show();}, params.primeColorLong.blank_before_prime_duration + params.primeColorLong.prime_duration + params.primeColorLong.ISI);
		setTimeout(function(){$(".target").hide(); time_after_target = $.now(); time_before_blank2 = $.now(); $(".blank").show();}, params.primeColorLong.blank_before_prime_duration + params.primeColorLong.prime_duration + params.primeColorLong.ISI + params.primeColorLong.target_duration);
		setTimeout(function(){$(".blank").hide(); time_after_blank2 = $.now(); time_before_mask = $.now();$(".mask").show();}, params.primeColorLong.blank_before_prime_duration + params.primeColorLong.prime_duration+ params.primeColorLong.ISI + params.primeColorLong.target_duration + params.primeColorLong.blank_after_target_duration);
		setTimeout(function(){$(".mask").hide(); time_after_mask = $.now(); time_before_blank3 = $.now();$(".blank").show();}, params.primeColorLong.blank_before_prime_duration + params.primeColorLong.prime_duration+ params.primeColorLong.ISI + params.primeColorLong.target_duration + params.primeColorLong.blank_after_target_duration + params.primeColorLong.mask_duration);
...
},params.primeColorLong.blank_before_prime_duration + params.primeColorLong.prime_duration + params.primeColorLong.ISI + params.primeColorLong.target_duration + params.primeColorLong.blank_after_target_duration + params.primeColorLong.mask_duration + params.primeColorLong.blank_after_mask);
	}	
	...
	function takeBreak(){
		$( ".color-circle" ).hide();
		if(trial == 0){
			if(params.primeColorLong.displayExperNum == 1){setMessage("This is task " + currentExperNum + "/" + protocolList.length + "\n\n"+ preExperInstruction);}else{setMessage(preExperInstruction);}

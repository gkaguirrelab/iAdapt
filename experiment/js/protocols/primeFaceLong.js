...
$("#directions2").css({
	...
	function executeTrial(){
		...
		setTimeout(function(){$(".blank").hide();time_after_blank1 = $.now(); time_before_target = $.now();$(".target").show();}, params.primeFaceLong.blank_before_prime_duration + params.primeFaceLong.prime_duration + params.primeFaceLong.ISI);
		setTimeout(function(){$(".target").hide(); time_after_target = $.now(); time_before_blank2 = $.now(); $(".blank").show();}, params.primeFaceLong.blank_before_prime_duration + params.primeFaceLong.prime_duration + params.primeFaceLong.ISI + params.primeFaceLong.target_duration);
		setTimeout(function(){$(".blank").hide(); time_after_blank2 = $.now(); time_before_mask = $.now();$(".mask").show();}, params.primeFaceLong.blank_before_prime_duration + params.primeFaceLong.prime_duration+ params.primeFaceLong.ISI + params.primeFaceLong.target_duration + params.primeFaceLong.blank_after_target_duration);
		setTimeout(function(){$(".mask").hide(); time_after_mask = $.now(); time_before_blank3 = $.now();$(".blank").show();}, params.primeFaceLong.blank_before_prime_duration + params.primeFaceLong.prime_duration+ params.primeFaceLong.ISI + params.primeFaceLong.target_duration + params.primeFaceLong.blank_after_target_duration + params.primeFaceLong.mask_duration);
...
},params.primeFaceLong.blank_before_prime_duration + params.primeFaceLong.prime_duration + params.primeFaceLong.ISI + params.primeFaceLong.target_duration + params.primeFaceLong.blank_after_target_duration + params.primeFaceLong.mask_duration + params.primeFaceLong.blank_after_mask);
	}
	...
	function takeBreak(){
		$( ".face-circle" ).hide();
		if(trial == 0){
			if(params.primeFaceLong.displayExperNum == 1){setMessage("This is task " + currentExperNum + "/" + protocolList.length + "\n\n"+ preExperInstruction);}else{setMessage(preExperInstruction);}
	...
	$("html").click(function(){
		if($(".color-circle").is(":visible")){
			...
			/*
				...
				if(task == "primeColorLong" || task == "primeFaceLong"){
